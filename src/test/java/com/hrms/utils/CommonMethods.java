...
public class CommonMethods extends PageInitilizer{
	...
	public static String takeScreenshot(String fileName) {
		...
		String scrshotFile = Constants.SCREENSHORTS_FILEPATH + fileName + ".png";
		try {
	 ...
	 * @param visibleText
	 */
	public static void selecByVisibleText(WebElement element, String visibleText) {
	...
	/**
	 * This method will select value from the dropdown
	 * 
	 * @param element
	 * @param index
	 */
