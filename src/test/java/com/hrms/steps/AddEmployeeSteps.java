...
public class AddEmployeeSteps extends CommonMethods {
	...
	public void i_add_firstName_middleName_and_lastName(String fName, String mName, String lName) {
	...
	@Then("I see Employee with  {string}, {string} and {string}")
	public void i_see_Employee_with_name(String fname, String lname, String mname) {
